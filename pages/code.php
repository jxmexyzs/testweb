...
if (isset($_SESSION['username']) and is_admin($_SESSION['username'])) {
    ...
    <head>
        <title><?php echo $web_titles; ?> > Code</title>
...
h5{
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#addcodemodal">เติมโค้ด</button><br><br>
          ...
          <div class="">
            ...
            <h3 class="text-center mt-4 mb-4">--- สร้าง CODE ---</h3>
            <br>
            <div class="btn-group">
  ...
  <a href="Code-Script" class="btn btn-dark">สร้าง Code สคริป</a>
      ...
      <div class="table-responsive mt-3">
        ...
        <tbody>
                                    <?php 
                                    $query = mysqli_query(connDB(),"SELECT * FROM code");
                                    while($row = mysqli_fetch_array($query)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($row['status'] == 1){echo '<span class="badge bg-success">ยังไม่ถูกใช้งาน</span>';}else{echo '<span class="badge bg-danger">ใช้งานแล้ว</span>';} ?>
                                            </td>
